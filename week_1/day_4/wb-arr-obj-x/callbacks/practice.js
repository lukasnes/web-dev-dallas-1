...
let callbackFunc = function (firstName) {
...
first(names, callbackFunc);
first(nums, callbackFunc)
...
const printLast = function (lastName) {
  console.log('The last name in names is ' + lastName);
  return lastName;
}
// Do not edit the code below.
last(names, printLast);
// Do not edit the code above.
...
//     console.log(`The value of i is ${names[i]}, the value of j is ${names[j]}`)
//   }
// }
