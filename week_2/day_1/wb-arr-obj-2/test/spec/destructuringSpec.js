...
describe('ingredients', function () {
  ...
  it('should return the correct value', function () {
    expect(ingredients({ carb: 'flour', fat: 'butter', protein: 'eggs' }).sort()).toEqual(
      ['flour', 'butter', 'eggs'].sort(),
    );
    expect(ingredients({ carb: 'rice', fat: 'bacon grease', protein: 'chicken' }).sort()).toEqual(
      ['rice', 'bacon grease', 'chicken'].sort(),
    );
  });
});
