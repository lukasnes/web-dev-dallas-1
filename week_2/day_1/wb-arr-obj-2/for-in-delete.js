...
for(let property in values) {
  console.log(`The current value in the object loop is ${values[property]}`)
}
...
for(let property in values) {
  console.log(`The current key in the object loop is ${property}`)
}
...
function showValues(obj) {
  ...
  let string = ''
  for(let key in obj){
    console.log(`The current string is\n ${string}`)
    string += obj[key]
  }
  return string
}
...
let arr = ['These', ' are', ' the', ' property', ' values.']
let string = ''
